    ...
    methods: {
        ...
        callAPI: function(url){
            ...
            .then(response => {
                ...
                this.error_msg = '';
                this.tiles = response.board;
                this.board_type = response.type
                this.iterations = response.iterations;
                this.rs_wanted = this.rs_options[response.resource_spacing_score];
                this.ts_wanted = this.ts_options[response.token_spacing_score];
                this.rts_wanted = this.rts_options[response.resource_probability_score];
            })
            .catch(error => {
